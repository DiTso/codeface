...
for font in font_list:
    ...
    tp_command = """python2 render.py -t specimens/test-pattern.txt -l text -x 725 -b "#fcfdffff" -i ../images/gallery/""" + font_filename + """-STP.png -f '""" + font_name + """' -p 20"""

    # create compact test pattern command
    tpc_command = """python2 render.py -t specimens/test-pattern-compact.txt -l text -x 725 -b "#fcfdffff" -i ../images/gallery/""" + font_filename + """-STPC.png -f '""" + font_name + """' -p 20"""

    # create dark syntax higlighter command
    dh_command = """python2 render_highlight.py -t specimen/samplecode.c -x 725 -i ../images/gallery/""" + font_filename + """-dark.png -f '""" + font_name + """' -p 20 --style dark"""

    # create light syntax highlighter command
    lh_command = """python2 render_highlight.py -t specimen/samplecode.c -x 725 -i ../images/gallery/""" + font_filename + """-light.png -f '""" + font_name + """' -p 20 --style light"""
